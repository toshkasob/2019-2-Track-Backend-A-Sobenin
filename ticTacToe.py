...
class Tic_Tac_Toe(object):
    ...
    def askNamesOfPlayers(self):
        ...
        print(f"\n========================\n{self.namePlayer_1}\tvs\t{self.namePlayer_2}");
    ...
    def checkMarked(self, position):
        ...
        if not self.markedCell[1].count(pos_in_list) and not self.markedCell[-1].count(pos_in_list):
            return True;
        else :
    ...
    def game(self):
        '''game() - это и есть игра в крестики-нолики
